...
class InitDb {
    ...
    static class InitService {
        ...
        public void init() {
            ...
            GalleryFile galleryFile1 = createGalleryFile("test", "test", "test", filePath1, user2, "de38022c-a4a9-4b49-8498-8d51956ff4bf", 111111L);
            GalleryFile galleryFile2 = createGalleryFile("test", "test", "test", filePath2, user2, "de38022c-a4a9-4b49-8498-8d51956ff4bf", 111111L);
            GalleryFile galleryFile3 = createGalleryFile("test", "test", "test", filePath3, user2, "de38022c-a4a9-4b49-8498-8d51956ff4bf", 111111L);
            GalleryFile galleryFile4 = createGalleryFile("test", "test", "test", filePath2, user2, "ed31022c-a429-4f49-8112-1d55656zf4bf", 111111L);
            GalleryFile galleryFile5 = createGalleryFile("test", "test", "test", filePath4, user2, "ed31022c-a429-4f49-8112-1d55656zf4bf", 111111L);
            GalleryFile galleryFile6 = createGalleryFile("test", "test", "test", filePath5, user2, "ed31022c-a429-4f49-8112-1d55656zf4bf", 111111L);
            GalleryFile galleryFile7 = createGalleryFile("test", "test", "test", filePath3, user2, "zz33552c-a449-4f49-8sx2-1535656zf4bf", 111111L);
            GalleryFile galleryFile8 = createGalleryFile("test", "test", "test", filePath4, user1, "ki33552c-a449-4f49-8sx2-1535656zf4bf", 111111L);
            GalleryFile galleryFile9 = createGalleryFile("test", "test", "test", filePath5, user1, "we33552c-a449-4f49-8sx2-1535656zf4bf", 111111L);
            GalleryFile galleryFile10 = createGalleryFile("test", "test", "test", filePath6, user1, "ok33552c-a449-4f49-8sx2-1535656zf4bf", 111111L);
            GalleryFile galleryFile11 = createGalleryFile("test", "test", "test", filePath4, user1, "fk33552c-a449-4f49-8sx2-1535656zf4bf", 111111L);
        ...
        public void categoryInit() {
            ...
            em.persist(createItemImage(item1, "03c8cd2c-e525-4297-919e-103a9210ad3e", "test", filePath1, "test"));
            em.persist(createItemImage(item1, "03c8cd2c-e525-4297-919e-103a9210ad3e", "test", filePath2, "test"));
            em.persist(createItemImage(item2, "03ca3d2c-e525-4297-919e-103a9gk2od3e", "test", filePath2, "test"));
            em.persist(createItemImage(item2, "03czzd2c-e525-4297-919e-103a9gk2od3e", "test", filePath3, "test"));
            em.persist(createItemImage(item3, "03caod2c-e512-4297-919e-103a9gk2od3e", "test", filePath3, "test"));
            em.persist(createItemImage(item4, "03caod2c-e56f-4297-919e-103a9gk2od3e", "test", filePath4, "test"));
            em.persist(createItemImage(item5, "03caod2c-e5cx-4297-919e-103a9gk2od3e", "test", filePath5, "test"));
            em.persist(createItemImage(item6, "03caod2c-e525-4297-919e-103aagk3od3e", "test", filePath6, "test"));
            em.persist(createItemImage(item7, "03caod2c-e525-4292-919e-103dkgk2od3e", "test", filePath7, "test"));
            em.persist(createItemImage(item8, "03caod2c-e525-4197-919e-103a9gk2od3e", "test", filePath8, "test"));
            em.persist(createItemImage(item9, "03caod2c-e525-4297-909e-123a9gk2od3e", "test", filePath9, "test"));
        }
        ...
        private GalleryFile createGalleryFile(String title, String originFilename, String filename, String filepath, User user, String bundleId, Long bundleOrder) {
        ...
        private ItemImage createItemImage(Item item, String bundleId, String filename, String filePath, String originFilename) {
