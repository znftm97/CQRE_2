...
public class CreateUpdatePostDto {
    ...
    public CreateUpdatePostDto(String title, String content) {
        this.title = title;
        this.content = content;
    }

    public CreateUpdatePostDto(String title, String content, Long id, Board board, List<PostFileDto> files) {
        this.title = title;
        this.content = content;
        this.id = id;
        this.board = board;
